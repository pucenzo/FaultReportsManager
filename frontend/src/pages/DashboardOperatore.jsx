...
export function DashboardOperatore() {
  ...
  const fetchSegnalazioniOperatore = async () => {
      try{        
        const params = {};
  ...
  return (
    <div className="dashboard-container operatore-css">    
      ...
      {error && <div className="messaggio-errore">{error}</div>}
        ...
        <div className="table-container">
          ...
          <div className="header-tabella">
            ...
            <div className="colonna-cliente">Cliente</div>
            ...
            {segnalazioni.length === 0 ? (
              ...
              segnalazioni.map((segnalazione) => (
                <div key={segnalazione.id} className="riga-tabella">                  
                  ...
                  <div className="colonna-priorità"> {segnalazione.priorita} </div>
                  <div className="colonna-titolo"> {segnalazione.titolo} </div>
                  <div className="colonna-cliente"> {segnalazione.cliente ? `${segnalazione.cliente.nome} ${segnalazione.cliente.cognome}` : "-"} </div>
